...
class OrganisationTestCase(TestCase):
    def setUp(self):
        ...
        org.categories.add(self.category)
        org.keywords.add(self.keyword)
...
class OrganisationIncorrectInformationReportTestCase(TestCase):
    def setUp(self):
        ...
        self.organisation.categories.add(self.category)
        self.organisation.keywords.add(self.keyword)
